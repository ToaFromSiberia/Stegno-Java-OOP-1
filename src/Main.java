...
public class Main {
    public static void main(String[] args) {
        ...
        shop.printCatalog();
        User user1 = new User("Саша", "sasha");
        User user2 = new User("Маша", "Masha");
        user1.getCart().addProduct(category1.getProducts().get(0));
        user2.getCart().addProduct(category2.getProducts().get(1));
        category1.getProducts().remove(0);
        category2.getProducts().remove(1);
        System.out.println(user1.getLogin() + " - Покупки:");
        ArrayList<Product> user1Products = user1.getCart().getProducts();
        ...
        ArrayList<Product> user2Products = user2.getCart().getProducts();
